...
clear
echo ""
echo " Done Install Webmin" | lolcat
echo " $IP:10000"
echo " Script Installer By YakkoXCode•TPX"
}
function restart () {
...
echo " Script Installer By YakkoXCode•TPX" | lolcat
}
function uninstall () {
...
echo " AutoScriptVPS By SSH SEDANG" | lolcat
}
if [[ "$cek" = "perl" ]]; then
sts="${Info}"
else
